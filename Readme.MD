...
For instance in the Pizza class there is a special equals method. Try to crate the Java Doc:
...
Then tell the AI to pick up the details embedded in inline comments.
